...
var
  Bitmap: TBitmap;
begin
  Form1.image1.Picture.LoadFromFile('C:\Users\hoang\Google Drive\STUDYING\Pixel\PIXEL_N\temp.bmp');
  Bitmap := TBitmap.Create;
  try
    Bitmap.LoadFromFile('C:\Users\hoang\Google Drive\STUDYING\Pixel\PIXEL_N\temp.bmp');
  ...
  Picture := TPicture.Create;
    try
      ...
      try
        ...
        Bitmap.SaveToFile('C:\Users\hoang\Google Drive\STUDYING\Pixel\PIXEL_N\temp.bmp');
        image1.Picture.LoadFromFile('C:\Users\hoang\Google Drive\STUDYING\Pixel\PIXEL_N\temp.bmp');
      finally
        Bitmap.Free;
      end;
    finally
